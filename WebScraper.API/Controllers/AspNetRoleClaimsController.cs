...
namespace WebScraper.API.Controllers
{
    ...
    {
        private AspNetRoleClaimsFacade facade = new AspNetRoleClaimsFacade();
        [HttpPost]
        [Route("GetAll")]
        ...
        [HttpPost]
        [Route("AddPost")]
        public async Task<IActionResult> AddPost([FromBody]AspNetRoleClaims model)
        {
        ...
        [HttpPost]
        [Route("UpdatePost")]
        public async Task<IActionResult> UpdatePost([FromBody]AspNetRoleClaims model)
        {
            if (ModelState.IsValid)
            {
                try
