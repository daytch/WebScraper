...
namespace WebScraper.DataAccess.Repository
{
    public class TransactionRepository : ITransaction
    {
        ...
        public async Task<List<SP_ReportByStatusID>> GetReportByStatusID(long id, string endDate)
        {
            try
            {
                return await db.Set<SP_ReportByStatusID>().FromSqlRaw("EXEC sp_ReportByStatusID {0},{1}", id, endDate).AsNoTracking().ToListAsync();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public async Task<List<SP_GetAllBidByUserProfileID>> GetAllBidByUserProfileID(long UserProfileID)
        {
            ...
            try
            {
                return await db.Set<SP_GetAllBidByUserProfileID>().FromSqlRaw("EXEC sp_GetAllBidByUserProfileID {0}", UserProfileID).AsNoTracking().ToListAsync();
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<SP_GetAllAskByUserProfileID>> GetAllAskByUserProfileID(long UserProfileID)
        {
            try
            {
                return await db.Set<SP_GetAllAskByUserProfileID>().FromSqlRaw("EXEC sp_GetAllAskByUserProfileID {0}", UserProfileID).AsNoTracking().ToListAsync();
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<sp_GetAllBidAndBuyByUserProfileID>> GetAllBidAndBuyByUserProfileID(long UserProfileID)
        {
            try
            {
                return await db.Set<sp_GetAllBidAndBuyByUserProfileID>().FromSqlRaw("EXEC sp_GetAllBidAndBuyByUserProfileID {0}", UserProfileID).AsNoTracking().ToListAsync();
            }
            catch (Exception ex)
            {
